...
if __name__ == "__main__":
    ...
    """
    # Resampling file
    save_path = "./wavs/NGGYU_Chorus.wav"
    ...
    # Save as txt
    save_path = "./wavs/NGGYU_Chorus.txt"
    wav = Wav(file_path=file_path)
    wav.save_as_txt(save_path=save_path)

    # Filtering data
    # LPF
    save_path = "./wavs/lpf_filtered_NGGYU_Chorus.wav"
    wav = Wav(file_path=file_path)
    ...
    # HPF
    save_path = "./wavs/hpf_filtered_NGGYU_Chorus.wav"
    wav = Wav(file_path=file_path)
    ...
    plot_frequency_response(h=hn, fs=wav.sample_rate)
    # BPF
    save_path = "./wavs/bpf_filtered_NGGYU_Chorus.wav"
    wav = Wav(file_path=file_path)
    ...
    save_path = "./wavs/lpf_hpf_filtered_NGGYU_Chorus.wav"
    # LPF
